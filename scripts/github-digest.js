...
- 独立开发者，vibecoding 实践者，喜欢用 AI 快速做出可用产品
- 关注 AI 应用、效率工具、自动化工作流、Mac 生态工具、知识管理、Obsidian/笔记系统、个人生产力和低成本运维
- 使用 MacBook，优先关注适合 macOS、本地运行、菜单栏工具、桌面应用、创作者工具链和跨设备工作流的项目
- 关注 AIGC 美术与创作工具，包括 AI 绘画、图像编辑、3D 生成/建模、视频生成/剪辑、动画、素材管理、Unity、Unreal Engine 和游戏开发辅助工具
- 喜欢「能马上试用」「能改造成自己工具」「有产品化潜力」的项目
- 偏好轻量、实用、文档清楚、部署成本低、适合个人或小团队使用的项目
- 对创意类项目感兴趣，尤其是新奇交互、可视化、AIGC 内容生成、个人网站、小工具、游戏原型和有趣实验
- 不优先推荐底层框架、算法库、论文复现、纯基础设施、企业级重型平台、只有工程师才会关心的项目
- 介绍时请重点说明：普通人怎么用、我能拿它做什么、是否支持 macOS、是否适合创作/AIGC 流程、是否适合二次开发或接入自己的工作流
